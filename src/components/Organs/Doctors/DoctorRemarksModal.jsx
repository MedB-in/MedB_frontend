            ...
            <div className="relative bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl">
                ...
                <div className="flex items-center justify-between space-x-6 mb-6">
                    ...
                    <div className="flex flex-col text-right space-x-2 font-semibold">
                        ...
                        <div className="cursor-pointer hover:text-violet-600 hover:underline" onClick={() => navigate(`/app/patients/prescriptions/${appt?.patientDetails?.userId}`)}>Create Prescriptions</div>
                    </div>
                </div>
                {new Date(appt.appointmentDate.split("-").reverse().join("-")) === new Date() && (
