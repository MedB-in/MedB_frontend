            ...
            <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-8 pt-24">
                ...
                <div className="mt-8 text-center">
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                        ...
                        {status === "rejected" && "Unfortunately, your registration has been rejected. You may edit your details or contact support."}
                        {status === "pending" && "Your clinic registration is currently under review. MedB team may reach out to you for verification."}
                    </p>
                    {status === "rejected" && (
                    <p className="text-sm text-green-600 mt-2 hover:underline cursor-pointer" onClick={() => navigate(`/register-clinic/${registrationId}`)}>Edit your clinic details to update your registration.</p>
                    )}
                </div>
            </div>
        </div>
