...
const HeroSection = () => {
    ...
    <motion.div
        className="md:w-1/2 text-center md:text-left mt-24 md:mt-10"
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
    >
        <h2 className="text-3xl md:text-5xl font-extrabold bg-gradient-to-r from-purple-600 to-teal-400 bg-clip-text text-transparent">
            Welcome to Your Path to Wellness, Your Trusted Guide in the World of Health and Healing!
        </h2>
    </motion.div>

    <motion.div
        className="w-full md:w-1/2 flex justify-center items-center mt-10"
